...
export default function PrivacyPage() {
  return (
    <div style={{maxWidth: "800px", margin: "40px auto", padding: "20px", lineHeight: "1.6"}}>
      ...
      <p>
        Payment information is processed securely by our payment processor and is not stored on
        our servers.
      </p>
      ...
      <p>
        Reservation information may be stored securely in our booking system to manage stays,
        provide guest services, and meet accounting or legal obligations.
      </p>

      <h2>California Privacy Rights</h2>

      <p>
        If you are a California resident, you may request access to, correction of, or deletion
        of your personal information in accordance with applicable privacy laws.
      </p>

      <p>
        To submit a privacy request, please email us at:
      </p>

      <p>
        <strong>riversendstay@gmail.com</strong>
      </p>
